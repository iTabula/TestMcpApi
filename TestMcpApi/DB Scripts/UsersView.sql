...
AS
SELECT u.UserID, ur.BasicRoleID AS RoleID, r.Role, u.UserName, u.FirstName, u.MiddleName, u.LastName, u.FirstName + ' ' + u.LastName AS Name, u.FirstName + ' ' + u.MiddleName + ' ' + u.LastName AS FullName, u.CompanyName, u.Address, u.City, u.State, u.PostalCode, u.CountryID, u.DOB, LTRIM(RTRIM(REPLACE(REPLACE(REPLACE(REPLACE(u.Phone, '(', ''), ')', ''), '-', ''), ' ', ''))) As Phone, u.Email, u.Status, u.Sex, u.DateAdded, u.AddedBy, u.DateModified, u.ModifiedBy, u.LicenseNumber, u.LicensingEntity, u.NMLSID, u.BrokerFeeLoans, 
