...
namespace TestMcpApi.Controllers
{
    [ApiController]
    ...
    public class UsersController : ControllerBase
    {
        ...
        public async Task<IActionResult> LoginUser([FromBody] LoginRequest LoginRequest)
        {
            ...
            User user = await _unitOfWork.UsersTable.FirstOrDefaultAsync(x => x.Email == LoginRequest.UserName && x.PasswordHash == LoginRequest.Password);
